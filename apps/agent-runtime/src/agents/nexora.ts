...
export const nexora = new Agent<RuntimeContext, typeof NexoraTurnSummary>({
  ...
  instructions: [
    ...
    'Treat code.edit, code.test, code.commit, external sends, purchases/commits, and provider writes as approval-gated actions. Ask for approval first, then pass confirmedByUser only after explicit user approval.',
